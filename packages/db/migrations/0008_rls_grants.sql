...
--   REVOKE INSERT,UPDATE,DELETE ... FROM anon, authenticated   -- read-only to the web
...
revoke insert, update, delete on public.parcel from anon, authenticated;
...
revoke insert, update, delete on public.transfer from anon, authenticated;
...
revoke insert, update, delete on public.permit from anon, authenticated;
...
revoke insert, update, delete on public.violation from anon, authenticated;
...
revoke insert, update, delete on public.complaint from anon, authenticated;
...
revoke insert, update, delete on public.case_investigation from anon, authenticated;
...
revoke insert, update, delete on public.distress_inventory from anon, authenticated;
...
revoke insert, update, delete on public.sheriff_listing from anon, authenticated;
...
revoke insert, update, delete on public.crime_incident from anon, authenticated;
...
revoke insert, update, delete on public.service_request from anon, authenticated;
...
revoke insert, update, delete on public.parcel_change_log from anon, authenticated;
...
revoke insert, update, delete on public.delinquency_event from anon, authenticated;
...
revoke insert, update, delete on public.violation_event from anon, authenticated;
...
revoke insert, update, delete on public.geo_metric from anon, authenticated;
...
revoke insert, update, delete on public.geo_boundary from anon, authenticated;
